...
function createtable() {
    ...
    for (const entry of tableobj.entries()) {
        if (entry[1].length < 4) {
          ...
          id = entry[1][3].match(/_([0-9]*)-xfas/)[1];
          entry[1][3] = `https://go.rakuten.com/open-app?$deeplink_path=us%2Fstore%2F${id}%2Fshop%3Fspe=${entry[1][3].match(/special=([0-9]*)/)[1]}`;
          storeids.push(id);
        }
    }
      ...
      <table cellpadding="0" cellspacing="0" border="0">
         <tr>
            <td width="210">
               <table cellpadding="0" cellspacing="0" border="0">
                  <tr>
                     <td align="center"><a mobile="true" href="${link}&eeid=\${eeid}&%7Echannel=rakuten&utm_channel=email&%7Ecampaign=\${utmCampaign}&utm_content=\${utmDate}&ebtoken=\${Recipient.JWT_TOKEN}" style="text-decoration:none"><img src="https://static.ebates.com/\${ContextData['st${storeids[i-1]}'].large_logo}" alt="\${ContextData['st${storeids[i-1]}'].store_name}" height="40" width="150" border="0"></a></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                     <td style="line-height: 0px; font-size: 0px;" align="center" width="210"><a mobile="true" href="${link}&eeid=\${eeid}&%7Echannel=rakuten&utm_channel=email&%7Ecampaign=\${utmCampaign}&utm_content=\${utmDate}&ebtoken=\${Recipient.JWT_TOKEN}" style="text-decoration:none"><span style="display: inline"><img src="https://mg-cf.s3.amazonaws.com/img/15C3AD3A7F45A77D48AD7FF3FA2EEE5ED3FEAB5D/2019_NewHDTemplate/CirclePlus.png" width="24" height="20" style="display:inline;border:0;vertical-align:-0.5px;" alt=""></span><span style="font-family:'Benton Sans Med', Helvetica, Arial, San-serif; color:#ED5050;font-size:24px;line-height:28px;">X Cash&nbsp;Back in the App</span></a></td>
                  </tr>
               </table>
            </td>
            <td><img src="http://www.rakuten.com/email/x.gif" alt="" border="0" style="display:block;" height="1" width="10"></td>
            ...
            <td align="center" width="250">
               <table cellpadding="0" cellspacing="0" border="0">
                  <tr>
                     <td align="center"><a mobile="true" href="${link}&eeid=\${eeid}&%7Echannel=rakuten&utm_channel=email&%7Ecampaign=\${utmCampaign}&utm_content=\${utmDate}&ebtoken=\${Recipient.JWT_TOKEN}" style="text-decoration:none"><span style="font-family:'Benton Sans Reg', Helvetica, Arial, San-serif; color:#7e7e7e;font-size:24px; line-height: 28px;">${tableobj.get(i)[1]}</span></a></td>
                  </tr>
                  ${(tableobj.get(i)[2]!==' '?`<tr>
				 ...
				 <tr>
                  <td align="center"><a mobile="true" href="${link}&eeid=\${eeid}&%7Echannel=rakuten&utm_channel=email&%7Ecampaign=\${utmCampaign}&utm_content=\${utmDate}&ebtoken=\${Recipient.JWT_TOKEN}" style="text-decoration:none"><img src="https://mg-cf.s3.amazonaws.com/img/15C3AD3A7F45A77D48AD7FF3FA2EEE5ED3FEAB5D/2019_NewHDTemplate/ShopNow-CTA.png" width="156" border="0" style="display:block" alt="Shop Now"></a></td>
                  </tr>
               </table>
            </td>
         </tr>
